...
/*!
    ...
    \fn DoubleMatrix33 getRotationMatrixXYZ(const DoubleVec3D& angles)
    \brief Rotation matrix around the *z*, *y* and then *x* axis.
    ...
    \fn DoubleMatrix33 getScalingMatrixXYZ(const DoubleVec3D& values)
    \brief Scaling matrix on the *x*, *y* and *z* axis.
